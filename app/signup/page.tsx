...
import { createClient } from "@/utils/supabase/client"; // CHANGED: Updated import to use SSR-compatible client
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Using optimized URL for fast loading */}
        <img 
          src={BG_IMAGE_URL}
          alt="Stadium texture"
